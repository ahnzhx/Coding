...
(function($, undefined){
	...
	var DEFAULTS = {
		...
		left: false,
		titleHeight: 45,	// the height of the title of it is not specified in css
		footHeight: 40,
		...
		zIndex: 3333,			// the initial z-index of overlay and wrap. Just in case some other elements in document have greater z-index
